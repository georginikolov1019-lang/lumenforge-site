export default function Hero() {
  return (
    <section id="top" className="relative mx-auto max-w-6xl px-4 pb-20 pt-28 sm:px-6 sm:pt-32">
      <div className="absolute inset-x-0 top-10 -z-10 mx-auto h-64 max-w-3xl rounded-full bg-indigo-500/20 blur-3xl" />
      <p className="mb-4 inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs uppercase tracking-[0.2em] text-indigo-200">
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        <a href="#cta" className="rounded-full bg-gradient-to-r from-indigo-500 to-cyan-400 px-6 py-3 text-sm font-semibold text-zinc-950 shadow-glow transition hover:brightness-110">
          Start creating
        </a>
        <a href="#showcase" className="rounded-full border border-white/15 bg-white/5 px-6 py-3 text-sm font-medium text-white backdrop-blur hover:bg-white/10">
          Watch showcase
        </a>
      </div>
      <div className="mt-16 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-950/80 via-zinc-950 to-black p-1 shadow-glow">
        <div className="relative aspect-video overflow-hidden rounded-[1.35rem] bg-[#0a0b12]">
          ...
          <div className="absolute bottom-8 left-8 right-8 flex items-end justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-widest text-cyan-300/80">Preview reel</p>
